...
public class TimesAdapter extends RecyclerView.Adapter<TimesAdapter.LocationViewHolder> {
    ...
    public TimesAdapter(List<String> data, Context mContext) {
        this.mData = data;
    ...
    public void onBindViewHolder(LocationViewHolder holder, int position) {
        ...
        holder.times_textview.setText(item);
    }
    ...
    public class LocationViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public LocationViewHolder(View itemView) {
            super(itemView);
            times_textview = itemView.findViewById(R.id.location_textview);
